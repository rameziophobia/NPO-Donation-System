...
namespace NPODS_Non_Profit_Organizations_Donation_System {
    public partial class OrganizationDashboard : UserControl {
        ...
        public OrganizationDashboard() {
            ...
            this.pic_Banner.Image = Properties.Resources.Banner; //TODO THIS IS THE DEFAULT BANNER
        ...
        private void setRegions() {
            ...
            addLabel("Number of subscribtions", org.OrganizationStatistics.NumberOfSubs);
            addLabel("Number of Donators", org.OrganizationStatistics.UniqueDonators);

            this.pic_Banner.BringToFront();
            setVisibility("Money", org.OrganizationStatistics.hasMoneyDonations);
            setVisibility("Misc", org.OrganizationStatistics.hasMiscDonations);
        ...
        private void updateChart() {
            ...
            foreach (DateTime d in dates)
                S.Points.AddXY(d,org.OrganizationStatistics.getMonthlySubs()[d.Month - 1]);
        ...
        public void updateGoal() {
            if(goalProgress != null) {
                goalProgress.Value = (int)org.DonationGoal.CurrentProgress;
            }
        }
    }
}